...
\begin{tikzpicture}
    ...
    \coordinate (B'') at (14.6,6);
    \coordinate (C') at (18,7);
    \coordinate (C'') at (18,6);
    
    %Rectangle
    \draw[thick, fill=black!10] (10.5,5.8) rectangle (14.5,7.2);	
    \node at (12.2,6.5) {$\chi^2$};
    % Rays
    \draw[very thick, rayE2,color=blue] (A) -- (B);
    
    %% Bottom Ray
    \draw[very thick, rayE2,color=green] (B') -- (C');
    \draw[very thick, rayE2,color=red] (B'') -- (C'');
