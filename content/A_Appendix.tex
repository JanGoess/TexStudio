...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.65\textwidth]{Images/HistogramExample_2.pdf}
...
\begin{figure}[b!]
	\centering
	\includegraphics[width=.65\textwidth]{Images/VarMean_DeadTime_Afterpulsing_2.pdf}
...
\begin{figure}[h!]
	...
	\caption[Dark counts of the SNSPD]{(A): Dark counts in SNSPD channel 2; (B): Dark counts in SNSPD channel 3; (C): Dark counts in SNSPD channel 4}
	\label{fig:DC_SNSPD}
\end{figure}
