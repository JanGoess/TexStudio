...
\newcommand{\titel}{Parameter estimation with correlated photon pairs}
...
\newcommand{\unternehmen}{Institute of Applied Physics}
...
%\automark[section]{subsection} % left mark = section, right mark = subsection
...
\RedeclareSectionCommand[tocindent=0em,   tocnumwidth=2.5em, beforeskip=0.5ex, afterskip=0.5ex]{chapter}
\RedeclareSectionCommand[tocentryformat=\bfseries,tocindent=0em,tocnumwidth=2.5em, beforeskip=0.5ex]{section}
\RedeclareSectionCommand[tocindent=2.5em,tocnumwidth=3.5em,   beforeskip=0.5ex]{subsection}
\raggedbottom
...
\begin{document}
	...
	\addtocontents{toc}{\protect\addvspace{2ex}}
